...
app.post('/api/profile', async (req, res) => {
  ...
  // If subscription_tier is provided, update the users table
...
app.get('/api/recommendations', async (req, res) => {
  ...
  // 1. Fetch User and check subscription tier
  ...
  // Paywall: AI features only for Monthly or Yearly
